...
**Grupo:** @jvdellolio, @MiriamSsntos, @patrickmqs, @svfaca (sem matrículas no README)
...
| 05 | ADR | 0,0 | `docs/adr.md` existe mas fora da pasta `/docs/adrs/`; falta campo `Status:` explícito; conteúdo tem Contexto, Decisão, Consequências, Prós/Contras |
...
| 13 | Gatilhos de Risco | 0,0 | Coluna `Gatilho` presente com textos ≥20 caracteres, mas apenas 3 riscos (mínimo 5 exigidos pelo item 12) |
...
- Apenas 3 dos 19 arquivos de documentação exigidos existem: `adr.md` (fora da pasta correta), `operacao.md` (parcial) e `requisitos.md`.
